...
21. `2026-05-18-building-got-cheap-owning-didnt.md` — "Building Got Cheap. Owning Didn't." Concrete anchor: ~30% of MVP was scope Matias wouldn't have built if it weren't cheap. Friction-as-filter framing: cost of building used to filter for what was worth building; AI broke the filter. Ownership doesn't scale with build speed — individual pieces cheap to keep, but they compound (refactors sweep wider, migrations touch more, bugs hide in more places). Career anchor (anonymized): "is this the most impactful thing I could be working on?" — the right question when building was expensive, the right question now that it's cheap. ~440 words.
