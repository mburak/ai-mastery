...
image: /assets/images/post-1-hero.png
---
...
The first thing that got me was tokens. LLMs don't operate on words at all. They use subword tokens, pieces of words broken up by an algorithm called [byte pair encoding](https://en.wikipedia.org/wiki/Byte-pair_encoding){:target="_blank"}. Words are messy, so a fixed vocabulary of subword pieces can handle any language by breaking everything into known chunks.
